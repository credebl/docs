...
## PLATFORM
CREDEBL platform is an Open source, Open standards based Decentralised Identity & Verifiable Credentials Platform.
...
CREDEBL offers tools for digital credential management and verification, enabling organizations to issue and manage credentials easily. It also includes components such as the ADEYA wallet for storing and selectively sharing verifiable credentials. This platform is suitable for large-scale enterprise applications, using a microservices architecture to handle complex, distributed digital ecosystems ​<a href = "https://github.com/credebl/platform" target = "_blank">CREDEBL platform GitHub Repo</a>​ and <a href = "https://api.credebl.id/api" target = "_blank">CREDEBL Platform API link</a>.
